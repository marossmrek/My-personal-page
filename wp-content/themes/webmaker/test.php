...
if(!function_exists('custom_submit_job_form_fields')) {
    ...
    function custom_submit_job_form_fields(  $fields ) {
        ...
        $fields['company']['company_name']['placeholder'] = __('Enter your name', 'babysitter');
        $fields['company']['company_tagline']['placeholder'] = __('Briefly describe yourself', 'babysitter');
        $fields['company']['company_twitter']['placeholder'] = __('@yourname', 'babysitter');
        $fields['company']['company_video']['placeholder'] = __('A link to a video with you', 'babysitter');
        return $fields;
    }
}
